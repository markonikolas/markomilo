...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "splitTextToNodes": () => (/* binding */ splitTextToNodes)
/* harmony export */ });
var splitTextToNodes = function splitTextToNodes(title) {
  var _a;
...
/***/ "./src/ts/hooks/initInfiniteMenu.ts":
/*!******************************************!*\
  !*** ./src/ts/hooks/initInfiniteMenu.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _infiniteMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../infiniteMenu */ "./src/ts/infiniteMenu.ts");


var infiniteMenu = function infiniteMenu(data) {
  var navigation = document.querySelector('.main-navigation');
  var currentNamespace = data === null || data === void 0 ? void 0 : data.next.namespace;

  if (currentNamespace === 'Works' && navigation) {
    new _infiniteMenu__WEBPACK_IMPORTED_MODULE_0__["default"](navigation);
  }
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (infiniteMenu);

/***/ }),

/***/ "./src/ts/hooks/replaceBodyClass.ts":
/*!******************************************!*\
  !*** ./src/ts/hooks/replaceBodyClass.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var replaceBodyClass = function replaceBodyClass(data) {
  if (!data) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (replaceBodyClass);

/***/ }),

/***/ "./src/ts/hooks/setNavMenuItem.ts":
/*!****************************************!*\
  !*** ./src/ts/hooks/setNavMenuItem.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var setActiveNavItem = function setActiveNavItem(data) {
  var _a;
  ...
  try {
    var menuItems = document.getElementsByClassName('menu-item__link');
    var current = document.querySelector('.current-menu-item');
    var namespace = data.next.namespace;
    current === null || current === void 0 ? void 0 : current.classList.remove('current-menu-item');

    var nextActiveElement = _toConsumableArray(menuItems).find(function (item) {
      return item.getAttribute('data-barba-link') === namespace;
    });
    ...
    (_a = nextActiveElement === null || nextActiveElement === void 0 ? void 0 : nextActiveElement.parentElement) === null || _a === void 0 ? void 0 : _a.classList.add('current-menu-item');
  } catch (error) {
    throw new Error('Body data class was not found!');
  }
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (setActiveNavItem);

/***/ }),

/***/ "./src/ts/infiniteMenu.ts":
/*!********************************!*\
  !*** ./src/ts/infiniteMenu.ts ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ InfiniteMenu)
/* harmony export */ });
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var InfiniteMenu = /*#__PURE__*/function () {
  function InfiniteMenu(el) {
    ...
    this.DOM.menuItems = _toConsumableArray(this.DOM.el.querySelectorAll('.main__link'));
    this.clonesHeight = 0;
    this.scrollHeight = 0;
    this.scrollPos = 0;
    this.cloneItems();
  ...
  _createClass(InfiniteMenu, [{
    ...
    value: function scrollUpdate() {
      this.scrollPos = this.getScrollPos();
      var paddingTop = Number(window.getComputedStyle(this.DOM.el).paddingTop.split('px')[0]);
...
/* harmony import */ var _config_barba__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/barba */ "./src/ts/config/barba.ts");
/* harmony import */ var _hooks_replaceBodyClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hooks/replaceBodyClass */ "./src/ts/hooks/replaceBodyClass.ts");
/* harmony import */ var _hooks_setNavMenuItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hooks/setNavMenuItem */ "./src/ts/hooks/setNavMenuItem.ts");
...
function init() {
   ...
   * Init Barba config.
   */
  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().init(_config_barba__WEBPACK_IMPORTED_MODULE_1__["default"]);
  /**
   * Change active item on nav menu.
   */

  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.afterEnter(_hooks_setNavMenuItem__WEBPACK_IMPORTED_MODULE_3__["default"]);
  /**
   * Inject body class from next container's body.
   */

  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.afterLeave(_hooks_replaceBodyClass__WEBPACK_IMPORTED_MODULE_2__["default"]);
}
...
var transitionAfter = function transitionAfter(timeline) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _a, _b, textTimeline, curtain;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            textTimeline = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline();
            _context.next = 3;
            return timeline.to('.animation', {
              display: 'block',
              zIndex: 99,
              duration: 0
          ...
          case 3:
            ...
            (_a = document.querySelector('.animation-overlay')) === null || _a === void 0 ? void 0 : _a.classList.remove('visible');
            return _context.abrupt("return", (_b = document.querySelector('#curtain-path')) === null || _b === void 0 ? void 0 : _b.setAttribute('d', 'M0,1005S175,995,500,995s500,5,500,5V0H0Z'));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (transitionAfter);

/***/ }),

/***/ "./src/ts/transitions/before.ts":
/*!**************************************!*\
  !*** ./src/ts/transitions/before.ts ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./src/ts/helpers.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var transitionBefore = function transitionBefore(timeline) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _a, _b;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (_a = document.querySelector('.curtain')) === null || _a === void 0 ? void 0 : _a.classList.add('animate');
            (_b = document.querySelector('.animation-overlay')) === null || _b === void 0 ? void 0 : _b.classList.add('visible');
            (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.splitTextToNodes)(document.querySelector('.animation-text'));
            _context.next = 5;
            return timeline.fromTo('.curtain', {
              y: '-100%'
            }, {
              scaleY: 1.02,
              duration: 0.8,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (transitionBefore);

/***/ }),

/***/ "./src/ts/transitions/default.ts":
/*!***************************************!*\
  !*** ./src/ts/transitions/default.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./src/ts/helpers.ts");
/* harmony import */ var _once__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./once */ "./src/ts/transitions/once.ts");
/* harmony import */ var _before__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./before */ "./src/ts/transitions/before.ts");
/* harmony import */ var _after__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./after */ "./src/ts/transitions/after.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", (0,_once__WEBPACK_IMPORTED_MODULE_1__["default"])(timeline));
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", (0,_before__WEBPACK_IMPORTED_MODULE_2__["default"])(timeline));
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              title = data.next.container.querySelector('.main h1');
              title === null || title === void 0 ? void 0 : title.classList.add('animation-text', 'animation-text--page');
              (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.splitTextToNodes)(title);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (defaultTransition);

/***/ }),

/***/ "./src/ts/transitions/once.ts":
/*!************************************!*\
  !*** ./src/ts/transitions/once.ts ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var transitionOnce = function transitionOnce(timeline) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _a, _b, _c, _d, video, curtain;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (_b = document.querySelector('.animation-overlay')) === null || _b === void 0 ? void 0 : _b.classList.add('visible');
            (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.splitTextToNodes)(document.querySelector('.animation-text'));
            video = document.querySelector('.animation');
            _context.next = 6;
            return video.play();
          ...
          case 8:
            _context.next = 10;
            return timeline.to('.animation-overlay', {
              opacity: 1,
              duration: 0.5
            }).to('.animation', {
              display: 'block',
          ...
          case 10:
            _context.next = 12;
            return timeline.to('.animation-overlay .animation-text', {
              display: 'block',
              opacity: 1
          ...
          case 14:
            ...
            curtain.classList.remove('animate');
            curtain.style.transform = 'translateY(-100%)';
            (_c = document.querySelector('.animation-overlay')) === null || _c === void 0 ? void 0 : _c.classList.remove('visible');
            return _context.abrupt("return", (_d = document.querySelector('#curtain-path')) === null || _d === void 0 ? void 0 : _d.setAttribute('d', 'M0,1005S175,995,500,995s500,5,500,5V0H0Z'));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _hooks_initInfiniteMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../hooks/initInfiniteMenu */ "./src/ts/hooks/initInfiniteMenu.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
    ...
    return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              (0,_hooks_initInfiniteMenu__WEBPACK_IMPORTED_MODULE_0__["default"])(data);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmarkomilo"] = self["webpackChunkmarkomilo"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./src/ts/main.ts")))
